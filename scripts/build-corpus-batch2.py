...
CLIENTS = [
    ("Mr Gareth Pemberton", "23 Shadwell Lane, Leeds LS17 6DA"),
    ("Ms Rosalind Achebe", "9 Burley Lodge Terrace, Leeds LS6 1QP"),
    ("Cawthorne Fabrications Limited", "Bay 4, Stourton Link, Leeds LS10 1RJ"),
    ("Mrs Lydia Frankland", "51 Talbot Road, Leeds LS8 1LZ"),
    ("Mr and Mrs D Okonkwo", "17 Grange Croft, Leeds LS17 7EW"),
    ("Dr Alasdair Menzies", "88 Headingley Mount, Leeds LS6 3EQ"),
    ("Brindley Wharf Estates Limited", "Suite 6, Sovereign Quay, Leeds LS1 4BJ"),
    ("Mr Nathaniel Boakye", "5 Beckett Grove, Leeds LS9 6DL"),
    ("Mrs Wendy Threlfall", "62 Adel Lane, Leeds LS16 8DE"),
    ("Miss Orla Devaney", "11 Blenheim Walk, Leeds LS2 9AZ"),
    ("Sedgwick Precision Limited", "The Foundry, Hunslet Road, Leeds LS10 1JQ"),
    ("Ms Farrah Kazemi", "34 Woodhouse Cliff, Leeds LS6 2HG"),
    ("Mr Vincent Ollerenshaw", "7 Wetherby Grove, Leeds LS4 2JL"),
    ("Mrs Bridget Hanrahan", "29 Moor Allerton Drive, Leeds LS17 6RZ"),
    ("Mr Julian Ashcombe", "46 Stainbeck Road, Leeds LS7 2PS"),
    ("Halewood & Pike Limited", "Unit 12, Whitehall Riverside, Leeds LS1 4BN"),
    ("Ms Constance Mbeki", "18 Hyde Terrace, Leeds LS2 9LN"),
    ("Mr Duncan Rylance", "73 Chapeltown Road, Leeds LS7 4EE"),
]

PROPERTIES = [
    "14 Sandhill Oval, Leeds LS17 8EG",
    "Unit 9, Airedale Business Court, Leeds LS12 6AB",
    "3 Grosvenor Mount, Leeds LS6 2DX",
    "The Old Bindery, Marshall Street, Leeds LS11 9YJ",
    "62 Wood Nook Drive, Leeds LS16 7AJ",
