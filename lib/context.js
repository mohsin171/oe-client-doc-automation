...
// An error can carry structure alongside its message: which fields are missing, what came
// back from a model. The message is for the person, the rest is for the screen to act on.
export function bad(res, message, code = 400, extra = null) {
